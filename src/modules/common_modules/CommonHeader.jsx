    ...
    return (
        <>
            ...
            <header className="sticky top-0 z-40 w-full px-1 md:px-4 bg-background">
                <nav class="border-gray-200 px-1 md:px-4 lg:px-6 py-2.5">
                    <div class="flex flex-wrap justify-between items-center mx-auto w-full">
                        ...
                        <div class="hidden md:rounded-xl   justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                            ...
                            ">
                                <li>
                                    <div class="flex space-x-2 items-centerhover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-foreground dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                                        <span><Trophy className="ml-2" /></span>
                                        <span>{lastSentReward}</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="py-2 pr-4 pl-3 space-x-2 flex lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 lg:dark:hover:bg-transparent">
                                        <span><User /></span>
                                        <span>{cdDetails ? cdDetails.USERNAME : null}</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="block py-2 pr-4 pl-3 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 lg:dark:hover:bg-transparent">
                                        <ThemeToggle />
                                    </div>
                                </li>
                            </ul>
