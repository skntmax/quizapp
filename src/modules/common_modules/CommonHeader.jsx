            ...
            <header>
                <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                    <div class="flex flex-wrap justify-between items-center mx-auto w-full">
                        ...
                        <div data-collapse="mobile-menu-2" class="hidden md:rounded-xl md:border justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                            <ul class="flex justify-center flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                                <li>
